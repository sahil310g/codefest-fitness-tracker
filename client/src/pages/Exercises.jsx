...
const Exercises = () => {
    ...
    const data = [ "Running is a dynamic cardiovascular exercise that improves heart health, boosts endurance, and burns calories. It enhances mental well-being by reducing stress and promoting a positive mood. Additionally, running engages various muscle groups.",
    ...
    return (
        <div className='exercises-wrapper'>
            <Card sx={{ maxWidth: 345 }} style={{ marginRight: 80, marginLeft: 40, marginBottom: 20 }} >
                <CardMedia
